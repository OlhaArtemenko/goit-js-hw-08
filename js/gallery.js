...
// Cтворюємо розмітку елементів галереї через insertAdjacentHTML
...
// Створюємо подію прослуховування і делегування
gallery.addEventListener('click', function (event) {
  event.preventDefault();
  // Перевіряємо, чи клік був на елементі з класом gallery-image
  const clickedImage = event.target;
  if (clickedImage.classList.contains('gallery-image')) {
    // Отримуємо посилання на велике зображення з властивості original
